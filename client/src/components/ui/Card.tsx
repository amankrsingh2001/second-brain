...
export const Card = ({youTubelink, tweetLink}:cardVals) =>{
    return <div className="flex flex-col items-start rounded-lg  p-4 shadow-xl w-[20%] gap-2">
        ...
        <div className="flex flex-col w-full gap-2">
             <h1 className="text-xl font-light font-serif">Title</h1>
               <p className="text-md font-serif">Description of the card will be added here </p>
               {
                    ...
                    <iframe width="390" height="180" src={youTubelink} title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerPolicy="strict-origin-when-cross-origin" allowFullScreen></iframe>
                     </div>
               }
